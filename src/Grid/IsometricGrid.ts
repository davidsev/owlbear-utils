...
/** A true (30-degree) isometric grid. */
export class IsometricGrid extends BaseAxonometricGrid<Isometric> {
    public get type() {
        return 'ISOMETRIC' as const;
    }

    /** Converts a scene-space point to fractional (u, v) coordinates in this isometric projection. */
    ...
    /** Converts (u, v) coordinates back to a scene-space point in this isometric projection. */
    ...
    /** Returns the isometric cell that contains the given point. */
