...
/** A hex grid with flat-top cells (points left and right). */
export class HHexGrid extends BaseHexGrid<HHex> {
    public get type() {
        return 'HEX_HORIZONTAL' as const;
    }

    /** Converts a scene-space point to fractional axial (q, r) coordinates in this flat-top layout. */
    ...
    /** Converts axial (q, r) coordinates back to a scene-space point in this flat-top layout. */
